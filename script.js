...
let DATA = {
    authors: {
        ...
        notes: [
            {
                text: "At least one author has to register for the paper to be included in the proceedings.",
                highlight: false
            },
            {
                text: "Only registered authors will be allowed to present and receive certificates.",
                highlight: false
            },
            {
                text: "Keep a copy of your transaction ID and bank receipt to track your registration.",
                highlight: false
            },
            {
                text: "The committee is not responsible for financial losses caused by improper transactions.",
                highlight: true
            }
        ],
        submitPoints: [
            "Submit papers in DOC/DOCX format",
            "Maximum 6 pages (extra pages with additional charges)",
            "Ensure plagiarism is below 15%",
            "Follow all author guidelines before submission"
        ],
        contacts: [
            {
                name: "Dr. G. R. Bamnote",
            ...
            },
            {
                ...
                email: "hod_iiot@mitra.ac.in",
                mobile: "0721-2681246"
            },
            {
                name: "Dr. M. A. Pund",
                email: "hod_comp@mitra.ac.in",
                mobile: "0721-2681246"
            },
            {
                name: "Prof. Arpit Chaudhari",
                email: "auchaudhari@mitra.ac.in",
                mobile: "9021117416"
            }
        ]
    },
    committee: {
        ...
        technical: [
            ...
            },
            {
                role: "Co-Chair",
                name: "Dr. S. P. Ingale",
                org: "Assistant Prof, PRMITR, Badnera  "
            },
            {
                role: "Co-Chair",
                name: "Dr. S. G. Pundkar",
            ...
            },
            {
                ...
                org: "Head & Professor, Dept of IT, Rajiv Gandhi Institute of Technology, Mumbai "
            },
            {
                name: "Dr. Ankush Hutke",
                org: "Assistant professor, Dept of IT, Rajiv Gandhi Institute of Technology, Mumbai "
            },
            {
                name: "Mr. Roshan Halmare",
                org: "Lead Database Administrator, Global Payments, India "
            },
            {
                name: "Mr. Shyam Sharma",
                org: "Technical Lead, Wipro Technologies, India "
            },
            {
                name: " Dr. Amruta Deshmukh",
                org: " Ciena Corporation, USA "
            },
            {
                name: "Mr. Saurabh Deshmukh",
                org: "Senior Data Architect, Cognizant Worldwide, UK "
            },
            {
                name: " Mr. Apoorv Sawale",
                org: " Sr ETL Developer, ARAG Legal Insurance, USA "
            },
            {
                name: "Mr. Mangesh Pimprikar",
                org: "Technical Manager/ Architect, Cognizant Technology, USA"
            },
            {
                name: "Mr. Vinay Purushe",
                org: "Consultant, TCS, USA"
            },
            {
                name: "Mr. Ajinkya P. Chatur",
                org: "Senior Software Developer, U.S. Bancorp, USA"
            },
            {
                name: "Ms. Pooja Rajurkar",
                org: "Enterprisewide Manager, Siemens Healthineers, USA"
            },
            {
                name: "Mr. Hrishav Kumar",
                org: "SAP Operations Technical Team Lead, C&A, Germany"
            },
            {
                name: "Mr. Nilesh Sarode",
                org: "Software Engineer, United Health Group, Ireland"
            },
            {
                name: "Ms. Amruta Chorey",
                org: "Business Analyst, Blue Cross Blue Shield, USA"
            },
            {
                name: "Ms. Rashi Dhande",
                org: "Software Engineer, Progyny, USA"
            },
            {
                name: "Dr. Rohit Singh",
                org: "NIT Jalandhar"
            ...
            {
                name: "Dr. Monali Gulhane",
                org: "IEEE Senior Member, Assistant Professor, Symbiosis Institute Of Technology Nagpur"
            },
            {
                name: "Dr. Sachchidanand",
                org: "NIT Jalandhar"
            },
            {
            ...
            {
                name: "Dr. Kappala Vinod Kiran",
                org: "NIT Jalandhar"
            },
            {
                name: "Dr. Somesula Manoj Kumar",
                org: "NIT Jalandhar"
            },
            {
            ...
            {
                name: "Dr. Jailsingh Bhookya",
                org: "NIT Calicut"
            },
            {
                name: "Dr. Gautam Borkar",
                org: "Professor, Ramrao Adik Institute of Technology, Nerul Navi Mumbai"
            },
            {
                name: "Dr. Shivaji Lahane",
                org: "GES R.H. Sapat COE, Management Studies, Nashik"
            },
            {
                name: "Mr. Hemant Rajkule",
                org: "CEO, ASPEN Systems & Software, Pune"
            },
            {
                name: "Ms. Sapana Kawle",
                org: "Data Analyst, Nvidia, India"
            },
            {
                name: "Dr. Ankush D. Sawarkar",
                org: "Assistant Professor, SGGSIE&T, Nanded, India"
            },
            {
                name: "Prof. R. R. Papalkar",
                org: "Assistant Professor, VIT Pune"
            },
            {
                name: "Dr. Shreyash R. Hole",
                org: "Assistant Professor, SIT Nagpur"
            },
            {
                name: "Mr. Pratik B Raut",
                org: "Sr. Development Engg. Manager, Asimily India Pvt Ltd., India"
            },
            {
                name: "Dr. Sheetal S. Dhande",
                org: "Assistant Professor, Sipna Engg COE, Amravati"
            },
            {
                name: "Dr. Yogesh Thakare",
                org: "SRCOEM, Nagpur"
            },
            {
                name: "Dr. Jayendra Jadhav",
                org: "Assistant Professor, Vishwakarma University"
            },
            {
                name: "Prof. (Dr.) Satish N. Gujar",
                org: "Professor and Head of MTech, MSc, MCA Program, JSPM University Pune, India"
            },
            {
                name: "Dr. Sandeep S. Deshmukh",
                org: "Professor, Dept of Mechanical Engineering, BITS Pilani, Hyderabad Campus"
            },
            {
                name: "Dr. Shyamkumar Kalpande",
                org: "Professor & Head, Department of Mechanical Engineering, MET Bhujbal Knowledge City Nashik"
            },
            {
                name: "Dr. Vishal Sulakhe",
                org: "HOD Mechanical, Sandeep University Nashik"
            },
            {
                name: "Dr. Arun Thakare",
                org: "Associate Professor, GH Raisoni College of Engineering & Management, Pune"
            },
            {
                name: "Dr. Sunil Dambhare",
                org: "Director IQAC & Professor, Department of Mechanical Engineering, DY Patil International University Akurdi, Pune"
            },
            {
                name: "Dr. Sanjay Pohekar",
                org: "Professor & Head, Research Programs, Symbiosis Center of Research Innovation, Pune"
            },
            {
                name: "Dr. Avinash D Gawande",
                org: "Professor, SIPNA COE, Amravati"
            },
            {
                name: "Dr. Pradnya Borkar",
                org: "Associate Professor, Symbiosis Institute of Technology, Nagpur"
            },
            {
                name: "Dr. Poorva Agrawal",
                org: "Associate Professor, MPSTME, SVKM'S NMIMS, India"
            },
            {
                name: "Dr. Amol P. Bhopale",
                org: "Assistant Professor, IIIT Nagpur, India"
            },
            {
                name: "Prof. V. K. Bhangdiya",
                org: "IEEE Member, Assistant Professor, SSGMCE, Shegaon"
            },
            {
            ...
            {
                name: "Dr. Pradnya Borkar",
                org: "IEEE Senior Member, Associate Professor, Symbiosis Institute of Technology Nagpur"
            },
            {
                name: "Dr. Piyush Chavhan",
                org: "IEEE Senior Member, Associate Professor, Symbiosis Institute of Technology Nagpur"
            },
            {
                name: "Dr. Bhupesh Dewangan",
                org: "IEEE Senior Member, Associate Professor, Symbiosis Institute of Technology Nagpur"
            },
            {
                name: "Dr. Gaurav Londhe",
                org: "IEEE Senior Member, Associate Professor, Symbiosis Institute of Technology Nagpur"
            },
            {
                name: "Dr. Akhil Gupta",
            ...
            {
                name: "Dr. Mohan Kumar",
                org: "IEEE Senior Member, Professor, Symbiosis Institute of Technology Nagpur"
            },
            {
                name: "Dr. Priya Dasarwar",
                org: "Assistant Professor, IEEE Senior Member, Symbiosis Institute of Technology Nagpur"
            },
            {
                name: "Dr. Shreyash Hole",
                org: "IEEE Senior Member, Assistant Professor, Symbiosis Institute of Technology Nagpur"
            },
            {
            ...
            {
                name: "Dr. Harshala Shingane",
                org: "IEEE Senior Member, Assistant Professor, Symbiosis Institute of Technology Nagpur"
            },
            {
                name: "Dr. Mona Mulchandani",
                org: "IEEE Senior Member, Symbiosis Institute of Technology Nagpur"
            },
            {
                name: "Dr. Praful Pardhi",
                org: "IEEE Senior Member, Ramdev Baba University Nagpur"
            },
            {
                name: "Dr. Sandeep Uskewar",
                org: "IEEE Member, SVKM's Institute of Technology, Dhule"
            },
            {
                name: "Dr. Chetan Puri",
                org: "HoD CSE, IEEE Member, Faculty of Engineering and Technology, Datta Meghe Institute of Higher Education and Research (DU)"
            }
        ],
        publication: [
            {
                role: "Publication Chair",
                name: "Dr. Samir Deshmukh",
                org: ""
            },
            {
                role: "Publication Chair",
        ...
        advisory: [
            {
                role: "Advisory and Plenary Chair",
                name: "Dr. S. V. Pattalwar",
                org: ""
            },
            {
                role: "Advisory and Plenary Chair",
            ...
            {
                role: "Advisory and Plenary Chair",
                name: "Major Dr. V. A. Narayana",
                org: "Principal, CMR College of Engineering Technology, Kandlakoya, Hyderabad, Telangana"
            },
            {
                role: "Advisory and Plenary Chair",
                name: "Dr. Shankar D. Nawale",
                org: "Principal, SPSPM’s N. B. Nawale Sinhgad College of Engineering, Kegaon, Solapur"
            },
            {
                role: "Advisory and Plenary Chair",
                name: "Dr. Sanjay T. Gandhe",
                org: "Principal, PICT Pune"
            },
            {
                role: "Advisory and Plenary Chair",
                name: "Dr. Vikram Patil",
                org: "Principal, Faculty of Engineering, Yashoda Technical Campus, Satara"
            },
            {
                role: "Advisory and Plenary Chair",
                name: "Dr. S. D. Shirbahadurkar",
                org: "Principal, Dr. D. Y. Patil Technical Campus (DYPTC), Varale-Talegaon, Pune"
            },
            {
                role: "Advisory and Plenary Chair",
                name: "Pon Harshavardhanan",
                org: "Professor & Dean, VIT Bhopal"
            },
            {
                role: "Advisory and Plenary Chair",
                name: "Dr. Manoj B Chandak",
                org: "Principal & IEEE Member, RKEC, Nagpur"
            },
            {
                role: "Advisory and Plenary Chair",
                name: "Dr. Ashish Mahalle",
                org: "Principal, Govt. College of Engineering, Amravati"
            },
            {
                role: "Advisory and Plenary Chair",
                name: "Dr. Atul Borde",
                org: "Principal, Govt. Polytechnic, Amravati"
            },
            {
                role: "Advisory and Plenary Chair",
                name: "Dr. Nishant Saurabh",
                org: "Assistant Professor, Utrecht University, The Netherlands"
            },
            {
                role: "Advisory and Plenary Chair",
                name: "Dr. P. S. Deshpande",
                org: "Professor, VNIT, Nagpur"
            },
            {
                role: "Advisory and Plenary Chair",
            ...
            {
                role: "Advisory and Plenary Chair",
                name: "Mr. Anshuman Pund",
                org: "Chief Security Officer, SBM Bank, India"
            },
            {
                role: "Advisory and Plenary Chair",
                name: "Dr. Sonali Patil",
                org: "Professor & Head, Senior IEEE Member, PCCOE, Pune"
            },
            {
                role: "Advisory and Plenary Chair",
                name: "Mr. Narendra Kale",
                org: "Director, NN Technology Solutions, Navi Mumbai"
            },
            {
                role: "Advisory and Plenary Chair",
                name: "Dr. Sachin Sakhare",
                org: "Professor & Head, MMCOE"
            },
            
            {
                role: "Advisory and Plenary Chair",
                name: "Dr. Nilesh N. Thakur",
                org: "Professor, YCCE, Nagpur"
            },
            {
                role: "Advisory and Plenary Chair",
                name: "Dr. Mrs. A. V. Malviya",
                org: "IEEE Senior Member, Associate Professor, SIPNA COE, Amravati"
            },
            {
                role: "Advisory and Plenary Chair",
                name: "Dr. P. R. Deshmukh",
                org: "IEEE Senior Member, Associate Professor, Govt COE, Amravati"
            },
            {
                role: "Advisory and Plenary Chair",
                name: "Dr. S. B. Somani",
                org: "IEEE Member, Principal, SSGMCE, Shegaon"
            },
            {
                role: "Advisory and Plenary Chair",
                name: "Dr. Sandeep Kumar",
                org: "IEEE Senior Member, Deputy Director & Professor, SIT, Nagpur"
            }
        ],
        plagiarism: [
            {
                role: "Plagiarism and AI Checking Chair",
                name: "Dr. Pranjali Deshmukh",
                org: ""
            },
            {
                role: "Plagiarism and AI Checking Chair",
        ...
        operational: [
            ...
            {
                role: "Registration Chair",
                name: "Prof. V. N. Maldhure",
                org: ""
            },
            {
                role: "Registration Chair",
                name: "Prof. R. A. Wakode",
                org: ""
            },
            {
                role: "Registration Chair",
            ...
            {
                role: "Registration Chair",
                name: "Prof. S. P. Mahindre",
                org: ""
            },
            {
                role: "Hall Arrangement",
                name: "Prof. Saurabh Paropte",
                org: "Chair"
            },
            {
                role: "Hall Arrangement",
            ...
            {
                role: "Food Arrangement and Transportation Chair",
                name: "Prof. T. P. Adhau",
                org: "Chair"
            },
            {
            ...
            {
                role: "Publicity Chair",
                name: "Prof. H. D. Misalkar",
                org: ""
            },
            {
                role: "Publicity Chair",
                name: "Prof. A. R. Solanke",
                org: ""
            },
            {
                role: "Publicity Chair",
            ...
            {
                role: "Website and CMT Handling Chair",
                name: "Dr. S. S. Dandge",
                org: "Chair"
            },
            {
            ...
            {
                role: "Website and CMT Handling Chair",
                name: "Prof. A. G. Mahalle",
                org: ""
            },
            {
                role: "Website and CMT Handling Chair",
                name: "Prof. Ms. A. S. Chaudhari",
                org: ""
            },
            {
                role: "Website and CMT Handling Chair",
            ...
            {
                role: "Design and Printing Committee",
                name: "Dr. S. P. Akarte",
                org: "Chair"
            },
            {
                role: "Inauguration & Stage Arrangement Chair",
                name: "Dr. S. S. Tantarpale",
                org: "Chair"
            },
            {
                role: "Inauguration & Stage Arrangement Chair",
                name: "Dr. Ms. K. H. Deshmukh",
                org: ""
            },
            {
                role: "Inauguration & Stage Arrangement Chair",
                name: "Dr. Ms. M. A. Deshmukh",
                org: ""
            },
            {
                role: "Inauguration & Stage Arrangement Chair",
            ...
            {
                role: "Inauguration & Stage Arrangement Chair",
                name: "Prof. Ms. R. P. Sawarkar",
                org: ""
            },
            {
                role: "Inauguration & Stage Arrangement Chair",
                name: "Prof. Ms. N. K. Chede",
                org: ""
            },
            {
                role: "Press Notes Preparation & Photography Chair",
                name: "Dr. Smit Thakur",
                org: "Chair"
            },
            {
                role: "Press Notes Preparation & Photography Chair",
                name: "Prof. Ms. P. P. Deshmukh",
                org: ""
            },
            {
                role: "Minutes of Meetings and Documentation",
                name: "Dr. H. D. Patil",
                org: ""
            },
            {
                role: "Minutes of Meetings and Documentation",
                name: "Prof. P. V. Bobade",
                org: ""
            },
            {
                role: "Electrical Backup",
                name: "Prof. Amol Dhanbhar",
                org: ""
            }
        ]
    },
    dates: {
        dates: [
            {
                label: "Conference Website & CFP Launch",
...
function loadData() {
    // Data is already inlined for direct local file access.
}
...
function renderProgram() {
    const tracks = PROGRAM_TRACKS.map((t, index) => `
    <article class="program-track-card reveal">
      <h3 class="track-title">Track ${index + 1}: ${t.title}</h3>
      ...
      <div class="footer-inner">
        <div class="footer-grid">
          <div class="footer-brand-col">
            ...
            <p class="footer-desc">ICARIES 2027 is a hybrid IEEE conference (record number #72646) focused on innovative and resilient technologies in computing, artificial intelligence, data science, communication, robotics, and automation. It will be held at PRMITR Badnera on 26–27 February 2027.</p>
          </div>
        ...
        <div class="footer-bottom">
          <div class="footer-bottom-inner" style="display:flex;align-items:center;justify-content:space-between;gap:1rem;flex-wrap:wrap;">
            <div style="display:flex;flex-direction:column;">
              <span>© 2027 ICARIES — Prof. Ram Meghe Institute of Technology &amp; Research, Badnera. All rights reserved.</span>
